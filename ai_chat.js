<?php
// ไฟล์ PHP สำหรับรันบน XAMPP (Apache)
?>
<!DOCTYPE html>
<html lang="th">
<head>
...
<body>
    ...
    <div class="ai-screen">
        ...
        <div class="ai-input-area">
            ...
            <button type="button" onclick="sendAiMessage()">ส่งข้อความ</button>
        </div>
    </div>

    <script>
        // รองรับการกด Enter ส่งข้อความโดยไม่รีเฟรชหน้าเว็บ (ป้องกัน Error 405)
        ...
        function sendAiMessage() {
            ...
            setTimeout(() => {
                let reply = "ขออภัยครับ สำหรับคำถามนี้ แนะนำให้สังเกตอาการเบื้องต้นอย่างใกล้ชิด หรือพาน้องไปปรึกษากุมารแพทย์เพื่อความปลอดภัยและวินิจฉัยที่แม่นยำครับ";
                ...
                if(lowerText.includes('1 ขวบ') || lowerText.includes('ไม่พูด') || lowerText.includes('ขวบ')) {
                    ...
                    reply = "เด็กวัยเตาะแตะมักมีความอยากอาหารลดลงเพราะอัตราการเติบโตช้าลงครับ ตามความเป็นจริงควรจัดเวลาอาหารให้เป็นเวลา ไม่บังคับหรือดุว่าตอนทานข้าว และให้เด็กได้ลองหยิบจับอาหารเองเพื่อสร้างทัศนคติที่ดีต่อมื้ออาหารครับ";
                }
        ...
        // ฟังก์ชันป้องกันปัญหารหัส HTML รวน
